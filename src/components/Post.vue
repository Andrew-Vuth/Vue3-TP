        ...
        <div class="[ panel panel-default ] panel-google-plus">
          ...
          <div class="panel-heading">
            ...
            <h5>
              ...
              <span>{{ $store.state.posts[0].postedAt }}</span>
            </h5>
          </div>
          <div class="panel-body">
            <p>
              {{ $store.state.posts[0].content }}
            </p>
          </div>
          ...
          <div class="panel-google-plus-comment">
            ...
            />
            <form
              @submit.prevent="onPostCmt"
              class="panel-google-plus-textarea"
            >
              <textarea
                rows="4"
                style="padding: 10px"
    ...
    mounted() {
      $(function() {
        ...
        $(
          ...
          $comment.find('input[type="submit"]').addClass("disabled");
          if ($(this).val().length >= 1) {
            $comment.find('input[type="submit"]').removeClass("disabled");
          }
        });
      });
    },
...
<style scoped>
  ...
  .panel-google-plus.panel-google-plus-show-comment
    > .panel-footer
    > .input-placeholder {
    display: none;
  }
